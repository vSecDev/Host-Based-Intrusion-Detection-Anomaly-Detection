...
public interface TupleSet {
     ...
     */
    void addColumn(String name, Class type, Object defaultValue);
     ...
     */
    void addColumn(String name, String expr);
     ...
     * @see prefuse.data.expression
     */
    void addColumn(String name, Expression expr);
     ...
     */
    Iterator tuples(Predicate filter);
     ...
     */
    Iterator tuples(Predicate filter, Sort sort);
     ...
     */
    void addPropertyChangeListener(PropertyChangeListener lstnr);
     ...
     */
    void removePropertyChangeListener(PropertyChangeListener lstnr);
