...
class TreeTest extends FunSuite{
  ...
  test("Node updatePrediction has single element after first event update"){
    ...
    n.setKey(2)
    n.updateEvents(666)
    assert(n.getPredictions.get.size == 1)
  }
  test("Node updatePrediction has two elements after two different event key updates"){
    ...
    assert(n.getPredictions.get.size == 1)
    n.updateEvents(777)
    assert(n.getPredictions.get.size == 2)
  }
  ...
  test("Node predictions are correct"){
    ...
    n.setKey(2)
    n.updateEvents(666)
    assert(n.getPredictions.get(666) == 1.0)
    n.updateEvents(666)
    assert(n.getPredictions.get(666) == 1.0)
    n.updateEvents(777)
    assert(n.getPredictions.get(777) == 1.0/3)
    n.updateEvents(777)
    assert(n.getPredictions.get(777) == 2.0/4)
    n.updateEvents(888)
    assert(n.getPredictions.get(666) == 2.0/5)
    assert(n.getPredictions.get(777) == 2.0/5)
    assert(n.getPredictions.get(888) == 1.0/5)
    n.updateEvents(999)
    assert(n.getPredictions.get(666) == 2.0/6)
    assert(n.getPredictions.get(777) == 2.0/6)
    assert(n.getPredictions.get(888) == 1.0/6)
    assert(n.getPredictions.get(999) == 1.0/6)
  }
